...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    CFLAGS += --shell-file ./web/shell.html
    EXT = .html
endif
...
#    LDLIBS = $(RAYLIB_RELEASE_PATH)/libraylib.a
	LDFLAGS += -Lcontrib/raylib/lib/wasm
	LDFLAGS += -Lcontrib/lua/lib/wasm
    LDLIBS = -lraylib -llua
		#LDLIBS += -lxml2
endif
...
OBJS += $(patsubst %.c, %.o, $(PROJECT_SOURCE_FILES_C))
